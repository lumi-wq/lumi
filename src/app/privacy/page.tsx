    ...
    >
      ...
      <LegalSection title="2. Які дані ми збираємо">
        ...
        <ul className="list-disc space-y-1.5 pl-5">
          ...
          <li>
            дані аналітики та рекламних конверсій (за вашою згодою): сторінки, які ви відкриваєте,
            кліки по категоріях і товарах, додавання в кошик, орієнтовний час на сайті, пристрій,
            місто приблизно, звідки ви перейшли на сайт. Ці дані збирають Google Analytics і Google
            Ads і не містять вашого імені, телефону чи email.
          </li>
        </ul>
        <p>
      ...
      <LegalSection title="3. Навіщо нам ці дані">
        <ul className="list-disc space-y-1.5 pl-5">
          ...
          <li>
            ...
            виміряти рекламні конверсії — лише якщо ви прийняли аналітичні cookies;
          </li>
      ...
      <LegalSection title="4. Cookies та локальне зберігання">
        ...
        <ul className="list-disc space-y-1.5 pl-5">
          ...
          <li>
            <strong className="font-semibold text-obsidian">cookies Google Analytics і Google Ads</strong>{" "}
            — лише після натискання «Прийняти» в банері. Вони допомагають бачити відвідуваність,
            джерела трафіку, додавання в кошик і ефективність реклами. Ви можете відхилити аналітику
            або змінити вибір у підвалі сайту («Cookies»).
          </li>
        </ul>
        <p>
      ...
      <LegalSection title="5. Передача даних третім сторонам">
        ...
        <ul className="list-disc space-y-1.5 pl-5">
          ...
          <li>
            ...
            — якщо ви прийняли аналітичні cookies: дані про перегляди сторінок, події в каталозі,
            додавання в кошик і джерела трафіку (зокрема з реклами). Google може обробляти їх на
            серверах за межами України відповідно до своєї{" "}
            <a
