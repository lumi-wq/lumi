...
> = {
  outerwear: {
    ...
    boysIntro:
      "Верхній одяг для хлопчиків 6–16: куртки, парки, вітровки. Підбирайте за ростом, оплачуйте онлайн або післяплатою — доставка по Україні.",
    allIntro:
  ...
  pants: {
    ...
    short: "Штани",
    girlsIntro:
      "Штани для дівчаток 6–16 років — на кожен день і в школу. Дивіться наявні рости й замовляйте з післяплатою.",
    boysIntro:
      "Штани для хлопчиків 6–16: зручна посадка для школи, двору і прогулянок. Доставка Новою Поштою по Україні.",
    allIntro:
      "Дитячі штани 6–16 років. Купуйте онлайн на lumi.kids — доставка по Україні, оплата карткою або при отриманні.",
  },
  dresses: {
  ...
  hats: {
    ...
    boysIntro: "Шапки для хлопчиків 6–16 років. Доставка Новою Поштою, оплата на сайті або післяплата.",
...
export const DEFAULT_FAQ: SeoFaq[] = [
  ...
  },
  {
    ...
    a: "Так. Доставка Новою Поштою по Україні. Безкоштовна доставка від 1 500 ₴. Оформити замовлення можна лише на сайті lumi.kids.",
  },
  {
    q: "Чи можна оплатити післяплатою?",
    a: "Так. Доступна оплата карткою на сайті (Visa, Mastercard, Apple Pay, Google Pay) або післяплата при отриманні на Новій Пошті.",
  },
];
...
function typeLanding(
  ...
  return {
    ...
    description: `${seo.short} для ${g.ua} 6–16 років. Доставка Новою Поштою, післяплата. Інтернет-магазин LUMI.`,
    intro,
    gender: g.gender,
...
function rootTypeLanding(typeSlug: string): SeoLanding {
  ...
  return {
    ...
    description: `Дитячі ${seo.short.toLowerCase()} 6–16 років. Доставка Новою Поштою, післяплата. LUMI.`,
    intro: seo.allIntro,
    productTypeSlug: typeSlug,
    faq: DEFAULT_FAQ,
    related: [
...
function buildLandings(): SeoLanding[] {
  ...
  out.push(
    ...
    },
    {
      ...
      intro:
        "Верхній одяг і шапки на зиму. Підбір за ростом, доставка Новою Поштою по Україні, післяплата.",
